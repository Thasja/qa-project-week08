...
var toys = ['ball', 'puzzle', 'blocks', 'game', 'marbles'];
...
for (var index = 0; index < toys.length; index++) {
    alert(toys[index].substring(0,1).toUpperCase() + toys[index].substring(1).toLowerCase());
}
...
for (var index = 0; index < toys.length; index++) {
    sentence = sentence + ' ' + toys[index];
}

alert(sentence.substring(0));
